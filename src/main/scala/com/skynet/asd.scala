...
//    b.groupByKey.collect
    ...
    val text = sc.parallelize(  Array(("A","2019-12-23 10:23:45","" ,24,35 ,""),("B","2019-12-26 10:23:45","tong" ,6,38,""),("12","2019-12-26 10:23:49","tong" ,6,38,"123"),("13","2019-12-01 10:23:45","tong" ,25,65,"123")))
   ...
   val data1 =  value.map(_._1)
    ...
    val liu = data.join(data1).sortBy(_._2._1, false).distinct().groupByKey()
      ...
      tong(uuid1 ,uuid ,rdd._1._1 ,rdd._2.size ,list_qwe.mkString(",") ,d,Timestamp.valueOf(list_time.min)
