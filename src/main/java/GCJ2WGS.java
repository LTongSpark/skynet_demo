...
public class GCJ2WGS {
    ...
    public static void main(String[] args) {
        ...
        HashMap<String, Double> hm = wg.delta(25.7021836,100.17144178);

        System.out.println(hm);
    }
    //圆周率 GCJ_02_To_WGS_84
    double PI = 3.14159265358979324;
    /**{lon=100.17024403708893, lat=25.70517691810552}
     * {lon=100.17024405736979, lat=25.705176867420988}
     * @author 作者:
